-- Create sam_knowledge_base table if it doesn't exist (it should already exist)
-- This is just to ensure the table has all required columns

-- Add some comprehensive sample knowledge base entries for Sam Bryant
