...
const CaseStudiesPage = () => {
  const caseStudies = [
    {
      slug: 'mastercard-network-security',
      title: 'Mastercard Network Security',
      subtitle: 'Turning Crisis into Opportunity',
      value: '£2.1M ARR',
      duration: '6 months',
      description: 'How I navigated a complex enterprise security crisis to land the biggest new logo win of the year.',
      highlights: ['Multi-stakeholder orchestration', 'Crisis-to-opportunity conversion', 'Champion development'],
      icon: Building2,
    },
    {
      slug: 'fedex-cost-optimization',
      title: 'FedEx International Cost Optimization',
    ...
    {
      slug: 'johnson-matthey-transformation',
      title: 'Johnson Matthey Digital Transformation',
